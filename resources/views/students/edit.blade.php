...
@section('content')
    <div class="container my-1">
        ...
        {!! Form::open(['action' => ['StudentsController@update', $student->id], 'method' => 'POST', 'class' => 'border shadow p-4', 'enctype' => 'multipart/form-data']) !!}
            ...
            <div class="form-group" id="forSuffix">
                ...
                {{Form::select('suffix', [
                    ...
                    'Jr.' => 'Jr.',
                    'Sr.' => 'Sr.'
            ], $student->Suffix, ['class' => 'form-control', 'id' => 'suffix'])}}
            </div>
            <div class="form-group">
